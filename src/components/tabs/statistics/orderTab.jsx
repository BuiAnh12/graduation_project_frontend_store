...
export default function OrderTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-lg font-semibold mb-2">Đơn hàng theo thời gian</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <h3 className="text-lg font-semibold mb-2">Tỷ lệ hoàn tất vs huỷ</h3>
          ...
          <div className="w-full h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={timeSlotData}>
                ...
                <YAxis />
                <Tooltip />
                <Bar dataKey="orders" name="Order" fill="#8b5cf6" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
